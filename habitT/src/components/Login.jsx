...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.username && form.password) {
      ...
      setMessage({ type: "error", text: "Login fallito: inserisci username e password." });
    }
  };
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center mb-4 gap-2">
        <h2 className="text-xl sm:text-2xl font-semibold text-blue-400">Login</h2>
        <img src="/register.png" alt="Login" className="h-5 w-5 sm:h-6 sm:w-6" />
      </div>
      <input
        type="text"
        name="username"
